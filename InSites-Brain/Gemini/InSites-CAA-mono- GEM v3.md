...
- CRITICAL: Do NOT use mock data, setTimeout, or hardcoded responses. You MUST implement a live Gemini API connection as specified in section 4j.
...
1. **Auth:** Declare `const apiKey = "";` (Environment auto-injects the real key at runtime).
