...
file(s) from the Gem's knowledge files. Do not act from memory of the spec.
...
* **Density Mandate**: Apply **CA-EV in cbsa-reference.md** evidentiary tagging `[str, mat, sci]` to every claim and utilize maximum technical depth of **CA-V in cbsa-reference.md** across all stages.
