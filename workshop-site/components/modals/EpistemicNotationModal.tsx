    ...
    >
      <div className="text-left space-y-6" dir="ltr">
        <div className="py-4 space-y-4">
          <p className="text-sm font-black text-slate-400 uppercase tracking-widest">The tension</p>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50">
                <th className="p-3 font-bold text-sm uppercase tracking-wider text-slate-500 border-b border-slate-200 w-24">Notation</th>
                <th className="p-3 font-bold text-sm uppercase tracking-wider text-slate-500 border-b border-slate-200">Status</th>
                <th className="p-3 font-bold text-sm uppercase tracking-wider text-slate-500 border-b border-slate-200">Prose Style</th>
              </tr>
            </thead>
            <tbody className="text-base">
              <tr className="bg-emerald-50/50 hover:bg-emerald-50 transition-colors">
                ...
                <td className="p-4 border-b border-slate-100">
                  ...
                  <p className="text-slate-500 text-base mt-1">Directly stated in user-supplied material</p>
                </td>
              ...
              <tr className="bg-amber-50/50 hover:bg-amber-50 transition-colors">
                ...
                <td className="p-4 border-b border-slate-100">
                  ...
                  <p className="text-slate-500 text-base mt-1">Synthesized from 2+ pieces of evidence — must cite both</p>
                </td>
                <td className="p-4 border-b border-slate-100 text-slate-600">
              ...
              <tr className="bg-purple-50/50 hover:bg-purple-50 transition-colors">
                ...
                <td className="p-4 border-slate-100">
                  ...
                  <p className="text-slate-500 text-base mt-1">Neither explicit nor confidently inferred — reading between the lines</p>
                </td>
        ...
        <div>
          ...
          <div className="space-y-3">
            <div className="p-4 bg-emerald-50 border-l-4 border-emerald-400 rounded-r-lg">
              <p className="text-base font-bold text-emerald-700 uppercase tracking-wider mb-1">Explicit</p>
              <p className="text-base text-slate-700">
                "Built in 1923 as a water tower for Kibbutz Ayelet HaShachar" <span className="text-slate-400 font-mono text-sm">[A:2]</span>
              </p>
            </div>
            <div className="p-4 bg-amber-50 border-l-4 border-amber-400 rounded-r-lg">
              <p className="text-base font-bold text-amber-700 uppercase tracking-wider mb-1">Inferred 〰️</p>
              <p className="text-base text-slate-700">
                "The tower <em>may have served</em>〰️ as a regional landmark, given its elevated position and the absence of competing structures" <span className="text-slate-400 font-mono text-sm">[A:3, B:1]</span>
              </p>
            </div>
            <div className="p-4 bg-purple-50 border-l-4 border-purple-400 rounded-r-lg">
              <p className="text-base font-bold text-purple-700 uppercase tracking-wider mb-1">Interpretive 💭</p>
              <p className="text-base text-slate-700">
        ...
        <div className="bg-slate-50 p-5 rounded-xl border border-slate-200">
          <h4 className="font-bold text-slate-800 text-base mb-2">Prose-Notation Coherence</h4>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div className="p-3 bg-blue-50 rounded-lg border border-blue-100">
            <p className="text-sm font-bold text-blue-700 uppercase tracking-wider mb-1">Stage 1 — Contexts</p>
            <p className="text-sm text-slate-600">Contexts emerging uniquely from the description (〰️), reading between the lines (💭)</p>
          </div>
          <div className="p-3 bg-amber-50 rounded-lg border border-amber-100">
            <p className="text-sm font-bold text-amber-700 uppercase tracking-wider mb-1">Stage 2 — Values</p>
            <p className="text-sm text-slate-600">Values inferred from cross-context analysis (〰️), values from subtext (💭)</p>
          </div>
          <div className="p-3 bg-slate-100 rounded-lg border border-slate-200">
            <p className="text-sm font-bold text-slate-700 uppercase tracking-wider mb-1">Throughout</p>
            <p className="text-sm text-slate-600">Every claim in every stage must be marked and cited [file:page]</p>
          </div>
        </div>
      </div>
    </Modal>
