        ...
        <div>
          ...
          <div className="space-y-3">
            <div className="p-4 bg-emerald-50 rounded-xl border border-emerald-200">
              <p className="text-sm font-bold text-emerald-700 uppercase tracking-wider mb-1">1. Surprise</p>
            ...
            <div className="p-4 bg-blue-50 rounded-xl border border-blue-200">
              <p className="text-sm font-bold text-blue-700 uppercase tracking-wider mb-1">2. Trust</p>
              <p className="text-base text-slate-700 italic">
            ...
            <div className="p-4 bg-amber-50 rounded-xl border border-amber-200">
              <p className="text-sm font-bold text-amber-700 uppercase tracking-wider mb-1">3. Open</p>
              <p className="text-base text-slate-700 italic">
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50">
                  <th className="p-3 font-bold text-sm uppercase tracking-wider text-slate-500 border-b border-slate-200 w-24">Tag</th>
                  <th className="p-3 font-bold text-sm uppercase tracking-wider text-slate-500 border-b border-slate-200">Action</th>
                  <th className="p-3 font-bold text-sm uppercase tracking-wider text-slate-500 border-b border-slate-200">Example</th>
                </tr>
              </thead>
              <tbody className="text-base">
                {[
                  ...
                  <tr key={tag} className="bg-white hover:bg-slate-50 transition-colors">
                    ...
                    <td className="p-3 border-b border-slate-100 text-slate-500 text-sm">{example}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div className="p-4 bg-indigo-50 rounded-xl border border-indigo-200">
              <p className="text-sm font-bold text-indigo-700 uppercase tracking-wider mb-2">Interaction Style</p>
            ...
            <div className="p-4 bg-purple-50 rounded-xl border border-purple-200">
              <p className="text-sm font-bold text-purple-700 uppercase tracking-wider mb-2">Trust Profile</p>
              <ul className="text-base text-slate-600 space-y-1">
            ...
            <div className="p-4 bg-slate-100 rounded-xl border border-slate-200">
              <p className="text-sm font-bold text-slate-700 uppercase tracking-wider mb-2">Bot Dependency</p>
              <ul className="text-base text-slate-600 space-y-1">
