      ...
      <div className="text-left space-y-6" dir="ltr">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="p-4 bg-emerald-50 rounded-xl border border-emerald-200">
            <h5 className="font-bold text-emerald-800 text-base mb-2">Evidence Mandate</h5>
            <p className="text-base text-slate-600 leading-relaxed">
              The bot uses <strong>only</strong> user-supplied material. Every claim is cited with
              <span className="font-mono bg-white px-1 rounded text-sm">[file:page]</span>.
          ...
          <div className="p-4 bg-blue-50 rounded-xl border border-blue-200">
            <h5 className="font-bold text-blue-800 text-base mb-2">Status Line</h5>
            ...
            <div className="bg-white p-2 rounded-lg border border-blue-100 font-mono text-sm text-slate-500">
          ...
          <div className="p-4 bg-amber-50 rounded-xl border border-amber-200">
            <h5 className="font-bold text-amber-800 text-base mb-2">Revision Control</h5>
            <p className="text-base text-slate-600 leading-relaxed">
          ...
          <div className="p-4 bg-rose-50 rounded-xl border border-rose-200">
            <h5 className="font-bold text-rose-800 text-base mb-2">Missing Data Warning</h5>
            <p className="text-base text-slate-600 leading-relaxed mb-2">
              If earlier context is unavailable, the bot warns explicitly before proceeding:
            </p>
            <div className="bg-white p-2 rounded-lg border border-rose-100 text-sm text-slate-600">
          ...
          <div className="p-4 bg-indigo-50 rounded-xl border border-indigo-200">
            <h5 className="font-bold text-indigo-800 text-base mb-2">Stage Anchoring (CSR Brief)</h5>
            <p className="text-base text-slate-600 leading-relaxed">
          ...
          <div className="p-4 bg-purple-50 rounded-xl border border-purple-200">
            <h5 className="font-bold text-purple-800 text-base mb-2">Provocative Reflection (DQR)</h5>
            <p className="text-base text-slate-600 leading-relaxed">
